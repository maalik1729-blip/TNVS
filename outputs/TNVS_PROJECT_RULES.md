...
- Never silently skip a fix from any stage.
- Never re-fix something listed in the "Already Fixed" section.
...
- After completing changes, run `npx tsc --noEmit` and report result
